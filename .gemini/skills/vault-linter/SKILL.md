...
```bash
# From vault root
python .gemini/skills/vault-linter/scripts/lint.py

# Unattended (no prompts)
python .gemini/skills/vault-linter/scripts/lint.py --unattended

# From outside the vault
python .gemini/skills/vault-linter/scripts/lint.py --vault /path/to/vault
```
